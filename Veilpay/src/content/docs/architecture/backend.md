...
Additional internal and privacy-track routes exist for backend-to-backend operations. They are authenticated and rate-limited, and are intentionally kept out of the public route reference.
