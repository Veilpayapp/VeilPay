...
Stellar assets can be funded and withdrawn through Stellar anchors using the standard interactive deposit and withdrawal flow. See [Fiat ramps](/docs/consumer-app/fiat-ramps).
...
See [Stellar Private Payments](/docs/privacy/stellar-spp).
