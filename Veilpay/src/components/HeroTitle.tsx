    ...
    <div className="relative flex flex-col items-center justify-center text-center max-w-4xl px-4 mt-[-10vh]">
      ...
      >
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-gray-400 to-[#111111] italic font-light tracking-normal text-[clamp(2.9rem,12.5vw,6.25rem)] my-1 -mt-6 md:-mt-[1.8rem] pb-4">
            Multi-chain
          </span>
