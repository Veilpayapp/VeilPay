...
- Violate any applicable law, including securities, tax, export control, or anti-money-laundering law;
- Facilitate the purchase or sale of illegal goods or services;
- Defraud, deceive, or exploit any person;
- Interfere with, disrupt, or attempt unauthorized access to the Service or its underlying infrastructure;
- Use the Service if you are legally prohibited from doing so in your jurisdiction.

We may suspend or terminate access, and where legally required report activity to relevant authorities, if we reasonably suspect a violation of this section.
...
THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE," WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS, IMPLIED, OR STATUTORY, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, OR THAT THE SERVICE WILL BE UNINTERRUPTED, SECURE, OR ERROR-FREE. WE DO NOT WARRANT THAT ANY PRIVACY MECHANISM WILL RENDER A TRANSACTION UNTRACEABLE OR ANONYMOUS.
